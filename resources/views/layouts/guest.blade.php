...
<body class="login">
    <div class="wrapper wrapper-login wrapper-login-full p-0">
        <div class="login-aside w-50" style="background-image: url('{{asset('assets/img/bg.png')}}'); background-repeat:no-repeat;background-size:cover;">
